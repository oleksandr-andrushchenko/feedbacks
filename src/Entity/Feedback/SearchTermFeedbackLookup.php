...
#[Entity(
    ...
    new SortKey('FEEDBACK_LOOKUP', ['feedbackLookupId']),
    [
        new GlobalIndex(
            'SEARCH_TERM_FEEDBACK_LOOKUPS_BY_SEARCH_TERM_NORMALIZED_TEXT_CREATED',
            new PartitionKey(null, ['searchTermNormalizedText'], 'search_term_feedback_lookup_normalized_text_pk'),
            new SortKey(null, ['createdAt'], 'search_term_feedback_lookup_created_at_sk'),
        ),
    ]
)]
class SearchTermFeedbackLookup
{
    /**
    ...
    public function __construct(
        ...
        private readonly string $feedbackLookupId,
        #[Attribute('user_id')]
