...
#[Entity(
    ...
    new SortKey('FEEDBACK_SEARCH', ['feedbackSearchId']),
    [
        new GlobalIndex(
            'SEARCH_TERM_FEEDBACK_SEARCHES_BY_SEARCH_TERM_NORMALIZED_TEXT_CREATED',
            new PartitionKey(null, ['searchTermNormalizedText'], 'search_term_feedback_search_normalized_text_pk'),
            new SortKey(null, ['createdAt'], 'search_term_feedback_search_created_at_sk'),
        ),
    ]
)]
class SearchTermFeedbackSearch
{
    /**
    ...
    public function __construct(
        ...
        private readonly string $feedbackSearchId,
        #[Attribute('user_id')]
