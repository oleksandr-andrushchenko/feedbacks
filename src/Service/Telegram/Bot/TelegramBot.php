 ...
 * @method ServerResponse getFile(array $data)
 * @method ServerResponse deleteWebhook(array $data = [])
 * @method ServerResponse sendMessage(array $data)
 * @method ServerResponse sendPhoto(array $data)
 * @method ServerResponse sendVideo(array $data)
 * @method ServerResponse sendMediaGroup(array $data)
