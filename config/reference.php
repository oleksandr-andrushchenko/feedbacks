 ...
 * @psalm-type DynamodbConfig = array{
 *     client?: scalar|Param|null, // Service ID of the AWS DynamoDB client to use
 *     marshaler?: scalar|Param|null, // Service ID of the AWS Marshaler to use
 *     serializer?: scalar|Param|null, // Service ID of the Symfony Serializer to use
 *     logger?: scalar|Param|null, // Service ID of the Logger to use
 *     table?: scalar|Param|null, // Default DynamoDB table name // Default: null
 * }
